<template>
  <erp-full-screen-dialog
    ...
    <template v-slot:default>
      ...
      <erp-table ref="clientTableRef" :find-dto="findClientDto" :getRowId="getRowNodeId"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    //表格行id设置
    function getRowNodeId(params: GetRowIdParams<IClient>) : string{
      return String(params.data.clientid)
    }
