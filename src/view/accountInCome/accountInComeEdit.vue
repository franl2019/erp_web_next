<template>
  <erp-page-box>
    ...
    <erp-form>
      <erp-form-item v-if="editDto.accountInComeCode" name="单据编号" lg-col="1" md-col="2">
    ...
    <erp-table ref="editAccountInComeAmountMxTableRef" :find-dto="{}" :getRowId="getRowNodeIdForAmountMx"
    ...
    <erp-table ref="editAccountInComeSheetMxTableRef" :find-dto="{}" :getRowId="getRowNodeIdForSheetMx"
...
export default defineComponent({
  ...
  setup() {
    ...
    //表格行id设置
    function getRowNodeIdForAmountMx(params: GetRowIdParams<IAccountInComeAmountMx>) : string{
      return String(params.data.printId)
    }

    //表格行id设置
    function getRowNodeIdForSheetMx(params: GetRowIdParams<IAccountInComeSheetMxFind>) : string{
      return String(params.data.printId)
    }
