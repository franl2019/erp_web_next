...
export const selectedAccountInComeSheetMxTableConfig = ref<ITableConfig<IAccountsReceivableFind>>({
    tableName: "selectedAccountInComeSheetMxTableConfig",
    gridOptions: {
        defaultColDef: {
    ...
    columnDefaults: [
        ...
        {headerName: '应付账款类型', field: 'accountsReceivableType', cellRenderer: Table_accountReceivableType},
