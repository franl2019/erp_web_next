<template>
  <erp-page-box>
    ...
    <erp-table
        ...
        :getRowId="getHeadTableRowNodeId"
...
export default defineComponent({
  ...
  setup(_props, {expose}) {
    ...
    //表格行id设置
    function getHeadTableRowNodeId(params: GetRowIdParams<IOutbound>) : string{
      return String(params.data.outboundid)
    }

    //明细表格行id设置
    function getMxTableRowNodeId(params: GetRowIdParams<IOutboundMx>) : string{
