<template>
 <div class="flex flex-col h-full">
  ...
  <create-user-buy-operatearea-permission-dialog
   ...
   :create-buy-operatearea-dto="createBuyOperateareaDto"></create-user-buy-operatearea-permission-dialog>
</template>

<script setup lang='ts'>
import {DefaultUserBuyOperateAreaMxTableState} from "@/view/auth/user_operatearea_mx/buy/tableState/defaultUserBuyOperateAreaMxTableState";
