...
} from "@/view/auth/userOperateareaMx/buy/tableState/defaultUserBuyOperateAreaMxTableState";
...
import CreateUserBuyOperateareaPermissionDialog
  from "@/view/auth/userOperateareaMx/buy/components/createUserBuyOperateareaPermissionDialog.vue";
