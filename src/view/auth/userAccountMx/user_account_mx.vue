    ...
    >
      <template #topBox>
        <erp-button :size="'mini'"
                    @click="clickedCreateBtn"
        >新增权限
        </erp-button>
        <erp-button :size="'mini'"
                    type="danger"
                    @click="clickedDeleteBtn"
        >删除权限
        </erp-button>
      </template>
    </erp-table>
...
import AccountAuthCreateDialog from "@/view/auth/userAccountMx/components/accountAuthCreateDialog.vue";
...
} from "@/view/auth/userAccountMx/tableConfig/defaultUserAccountAuthTableState";
