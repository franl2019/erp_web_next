...
export const selectedAccountExpenditureSheetMxTableConfig = ref<ITableState<IAccountsPayableFind>>({
    tableName: "selectedAccountExpenditureSheetMxTableConfig",
    gridOptions: {
        defaultColDef: {
    ...
    columnDefaults: [
        ...
        {headerName: '应付账款类型', field: 'accountsPayableType',cellRendererFramework:Table_accountPayableType},
