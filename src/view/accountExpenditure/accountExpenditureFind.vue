<template>
  <erp-page-box>
    ...
    <erp-table
        ...
        :getRowId="getRowNodeId_headTable"
...
export default defineComponent({
  ...
  setup(props, {expose}) {
    ...
    //表格行id设置
    function getRowNodeId_headTable(params: GetRowIdParams<IAccountExpenditureFind>) : string{
      return String(params.data.accountExpenditureId)
    }
