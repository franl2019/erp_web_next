<template>
  <erp-page-box>
    ...
    <erp-form>
      ...
      <erp-form-item label-for-name="供应商" lg-col="2" md-col="2">
        <erp-select-buy-btn
            ...
            @select="onSelectedBuy"
            @unSelect="onUnSelectedBuy" :disabled="!state.edit"></erp-select-buy-btn>
      </erp-form-item>
    ...
    <erp-title title="付款明细">
      <erp-button type="danger" v-show="state.edit" @click="clickedAddAmountMxButton">增加明细</erp-button>
      <erp-button type="info" v-show="state.edit" @click="clickedDeleteAmountMxSelectedButton">删除选中</erp-button>
    </erp-title>
    ...
    <erp-title title="核付明细">
      <erp-button type="danger" v-show="state.edit" @click="clickedAddSheetMx">增加明细</erp-button>
      <erp-button type="info" v-show="state.edit" @click="clickedDeleteSelectedSheetMx">删除选中</erp-button>
    </erp-title>
...
//付款明细表设置id
function getRowNodeIdForAmountMx(data: IAccountExpenditureAmountMx) {
  return data.printId
}
