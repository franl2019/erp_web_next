<template>
  <erp-page-box>
    ...
    <erp-table
        ...
        :find-dto="{}"
        :getRowId="getInboundMxTableRowNodeId"
        :showTopBox="true"
...
import { CellEditingStartedEvent, GetRowIdParams } from "ag-grid-community";
...
export default defineComponent({
  ...
  setup() {
    ...
    //表格行id设置
    function getInboundMxTableRowNodeId(params: GetRowIdParams<IBuyInboundMxInTable>) : string{
