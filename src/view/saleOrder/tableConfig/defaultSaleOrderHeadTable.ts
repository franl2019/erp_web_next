...
export const defaultSaleOrderHeadTableConfig:ITableConfig<ISaleOrder> = {
    ...
    columnDefaults: [
        ...
        {headerName: '订货日期', field: 'orderDate', cellRenderer: Table_Date, width: 90},
        {headerName: '交货日期', field: 'deliveryDate', cellRenderer: Table_Date, width: 90},
        ...
        {headerName: '终止审核', field: 'stopReview', cellRenderer: Table_flag, width: 90},
        {headerName: '终止人', field: 'stopName', width: 68},
        {headerName: '终止日期', field: 'stopDate', cellRenderer: Table_Date, width: 90},

        {headerName: '手动完成审核', field: 'manualFinishReview', cellRenderer: Table_flag, width: 120},
        {headerName: '手动完成人', field: 'manualFinishName', width: 90},
        {headerName: '手动完成日期', field: 'manualFinishDate', cellRenderer: Table_Date, width: 120},

        {headerName: '加急审核', field: 'urgentReview', cellRenderer: Table_flag, width: 120},
        {headerName: '加急人', field: 'urgentName', width: 68},
        {headerName: '加急日期', field: 'urgentDate', cellRenderer: Table_Date, width: 120},
