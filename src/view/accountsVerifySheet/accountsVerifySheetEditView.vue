<template>
  <erp-page-box>
    ...
    <erp-table ref="accountsVerifySheetMxEditRef" :find-dto="{}" :getRowId="getRowNodeId" :table-edit="state.edit"
...
export default defineComponent({
  ...
  setup() {
    ...
    //表格行id设置
    function getRowNodeId(params: GetRowIdParams<IAccountsVerifySheetMx>) : string{
