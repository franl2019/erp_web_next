<template>
  <erp-page-box>
    ...
    <erp-table
        ...
        :find-dto="findDto"
        :getRowId="getRowNodeIdForHeadTable"
...
export default defineComponent({
  ...
  setup() {
    ...
    //表格行id设置
    function getRowNodeIdForHeadTable(params: GetRowIdParams<IAccountsVerifySheetFind>) : string{
      return String(params.data.accountsVerifySheetId)
    }
